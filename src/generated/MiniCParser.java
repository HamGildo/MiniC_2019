...
import generated.MiniCListener;
...
public class MiniCParser extends Parser {
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			System.out.println("201702087 Rule0");
			}
		}
	...
	public final DeclContext decl() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(39);
				var_decl();
				System.out.println("201702087 Rule1-1");
				}
				break;
			case 2:
				...
				setState(42);
				fun_decl();
				System.out.println("201702087 Rule1-2");
				}
				break;
			}
		}
	...
	public final Var_declContext var_decl() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(49);
				match(T__0);
				System.out.println("201702087 Rule2-1");
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				...
				setState(56);
				match(T__0);
				System.out.println("201702087 Rule2-2");
				}
				break;
			case 3:
				...
				setState(64);
				match(T__0);
				System.out.println("201702087 Rule2-3");
				}
				break;
			}
		}
	...
	public final Type_specContext type_spec() throws RecognitionException {
		...
		try {
			...
			case VOID:
				...
				setState(69);
				match(VOID);
				System.out.println("201702087 Rule3-1");
				}
				break;
			case INT:
				enterOuterAlt(_localctx, 2);
				...
				setState(71);
				match(INT);
				System.out.println("201702087 Rule3-2");
				}
				break;
			default:
	...
	public final Fun_declContext fun_decl() throws RecognitionException {
		...
		try {
			...
			setState(80);
			compound_stmt();
			System.out.println("201702087 Rule4");
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ParamsContext params() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				System.out.println("201702087 Rule5-1");
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				...
				setState(93);
				match(VOID);
				System.out.println("201702087 Rule5-2");
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
	...
	public final ParamContext param() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(99);
				match(IDENT);
				System.out.println("201702087 Rule6-1");
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				...
				setState(105);
				match(T__3);
				System.out.println("201702087 Rule6-2");
				}
				break;
			}
		}
	...
	public final StmtContext stmt() throws RecognitionException {
		...
		try {
			...
			case LITERAL:
				...
				setState(110);
				expr_stmt();
				System.out.println("201702087 Rule7-1");
				}
				break;
			case T__7:
				enterOuterAlt(_localctx, 2);
				...
				setState(113);
				compound_stmt();
				System.out.println("201702087 Rule7-2");
				}
				break;
			case IF:
				enterOuterAlt(_localctx, 3);
				...
				setState(116);
				if_stmt();
				System.out.println("201702087 Rule7-3");
				}
				break;
			case WHILE:
				...
				setState(119);
				while_stmt();
				System.out.println("201702087 Rule7-4");
				}
				break;
			case RETURN:
				...
				setState(122);
				return_stmt();
				System.out.println("201702087 Rule7-5");
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Expr_stmtContext expr_stmt() throws RecognitionException {
		...
		try {
			...
			setState(128);
			match(T__0);
			System.out.println("201702087 Rule8");
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final While_stmtContext while_stmt() throws RecognitionException {
		...
		try {
			...
			setState(135);
			stmt();
			System.out.println("201702087 Rule9");
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Compound_stmtContext compound_stmt() throws RecognitionException {
		...
		try {
			...
			setState(151);
			match(T__8);
			System.out.println("201702087 Rule10");
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Local_declContext local_decl() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(156);
				match(T__0);
				System.out.println("201702087 Rule11-1");
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				...
				setState(163);
				match(T__0);
				System.out.println("201702087 Rule11-2");
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
				...
				setState(171);
				match(T__0);
				System.out.println("201702087 Rule11-3");
				}
				break;
			}
		}
	...
	public final If_stmtContext if_stmt() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(180);
				stmt();
				System.out.println("201702087 Rule12-1");
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				...
				setState(189);
				stmt();
				System.out.println("201702087 Rule12-2");
				}
				break;
			}
		}
	...
	public final Return_stmtContext return_stmt() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(195);
				match(T__0);
				System.out.println("201702087 Rule13-1");
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				...
				setState(199);
				match(T__0);
				System.out.println("201702087 Rule13-2");
				}
				break;
			}
		}
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(205);
				match(LITERAL);
				System.out.println("201702087 Rule14-1");
				}
				break;
			case 2:
				{
				...
				setState(209);
				match(T__5);
				System.out.println("201702087 Rule14-2");
				}
				break;
			case 3:
				{
				setState(212);
				match(IDENT);
				System.out.println("201702087 Rule14-3");
				}
				break;
			case 4:
				{
				...
				setState(217);
				match(T__3);
				System.out.println("201702087 Rule14-4");
				}
				break;
			case 5:
				{
				...
				setState(223);
				match(T__5);
				System.out.println("201702087 Rule14-5");
				}
				break;
			case 6:
				{
				...
				setState(227);
				expr(20);
				System.out.println("201702087 Rule14-6");
				}
				break;
			case 7:
				{
				...
				setState(231);
				expr(19);
				System.out.println("201702087 Rule14-7");
				}
				break;
			case 8:
				{
				...
				setState(235);
				expr(18);
				System.out.println("201702087 Rule14-8");
				}
				break;
			case 9:
				{
				...
				setState(239);
				expr(17);
				System.out.println("201702087 Rule14-9");
				}
				break;
			case 10:
				{
				...
				setState(243);
				expr(5);
				System.out.println("201702087 Rule14-21");
				}
				break;
			case 11:
				{
				...
				setState(248);
				expr(2);
				System.out.println("201702087 Rule14-24");
				}
				break;
			case 12:
				{
				...
				setState(256);
				expr(1);
				System.out.println("201702087 Rule14-25");
				}
				break;
			}
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(263);
						expr(17);
						System.out.println("201702087 Rule14-10");
						}
						break;
					case 2:
						{
						...
						setState(268);
						expr(16);
						System.out.println("201702087 Rule14-11");
						}
						break;
					case 3:
						{
						...
						setState(273);
						expr(15);
						System.out.println("201702087 Rule14-12");
						}
						break;
					case 4:
						{
						...
						setState(278);
						expr(14);
						System.out.println("201702087 Rule14-13");
						}
						break;
					case 5:
						{
						...
						setState(283);
						expr(13);
						System.out.println("201702087 Rule14-14");
						}
						break;
					case 6:
						{
						...
						setState(288);
						expr(12);
						System.out.println("201702087 Rule14-15");
						}
						break;
					case 7:
						{
						...
						setState(293);
						expr(11);
						System.out.println("201702087 Rule14-16");
						}
						break;
					case 8:
						{
						...
						setState(298);
						expr(10);
						System.out.println("201702087 Rule14-17");
						}
						break;
					case 9:
						{
						...
						setState(303);
						expr(9);
						System.out.println("201702087 Rule14-18");
						}
						break;
					case 10:
						{
						...
						setState(308);
						expr(8);
						System.out.println("201702087 Rule14-19");
						}
						break;
					case 11:
						{
						...
						setState(313);
						expr(7);
						System.out.println("201702087 Rule14-20");
						}
						break;
					case 12:
						{
						...
						setState(318);
						expr(5);
						System.out.println("201702087 Rule14-22");
						}
						break;
					case 13:
						{
						...
						setState(323);
						expr(4);
						System.out.println("201702087 Rule14-23");
						}
						break;
					}
					} 
	...
	public final ArgsContext args() throws RecognitionException {
		...
		try {
			...
			case LITERAL:
				...
				System.out.println("201702087 Rule15-1");
				}
				break;
			case T__5:
				enterOuterAlt(_localctx, 2);
	...
	public static final String _serializedATN =
		...
		"\b\n\f\16\20\22\24\26\30\32\34\36 \2\2\2\u0177\2#\3\2\2\2\4/\3\2\2\2\6"+
		"E\3\2\2\2\bK\3\2\2\2\nM\3\2\2\2\fb\3\2\2\2\16n\3\2\2\2\20\177\3\2\2\2"+
		"\22\u0081\3\2\2\2\24\u0085\3\2\2\2\26\u008c\3\2\2\2\30\u00b0\3\2\2\2\32"+
		"\u00c2\3\2\2\2\34\u00cc\3\2\2\2\36\u0105\3\2\2\2 \u0158\3\2\2\2\"$\5\4"+
		...
		"\7\3\2\2\64\65\b\4\1\2\65F\3\2\2\2\66\67\5\b\5\2\678\7\"\2\289\7\4\2\2"+
		"9:\7#\2\2:;\7\3\2\2;<\b\4\1\2<F\3\2\2\2=>\5\b\5\2>?\7\"\2\2?@\7\5\2\2"+
		"@A\7#\2\2AB\7\6\2\2BC\7\3\2\2CD\b\4\1\2DF\3\2\2\2E\61\3\2\2\2E\66\3\2"+
		"\2\2E=\3\2\2\2F\7\3\2\2\2GH\7\26\2\2HL\b\5\1\2IJ\7\27\2\2JL\b\5\1\2KG"+
		"\3\2\2\2KI\3\2\2\2L\t\3\2\2\2MN\5\b\5\2NO\7\"\2\2OP\7\7\2\2PQ\5\f\7\2"+
		"QR\7\b\2\2RS\5\26\f\2ST\b\6\1\2T\13\3\2\2\2UZ\5\16\b\2VW\7\t\2\2WY\5\16"+
		"\b\2XV\3\2\2\2Y\\\3\2\2\2ZX\3\2\2\2Z[\3\2\2\2[]\3\2\2\2\\Z\3\2\2\2]^\b"+
		"\7\1\2^c\3\2\2\2_`\7\26\2\2`c\b\7\1\2ac\3\2\2\2bU\3\2\2\2b_\3\2\2\2ba"+
		"\3\2\2\2c\r\3\2\2\2de\5\b\5\2ef\7\"\2\2fg\b\b\1\2go\3\2\2\2hi\5\b\5\2"+
		"ij\7\"\2\2jk\7\5\2\2kl\7\6\2\2lm\b\b\1\2mo\3\2\2\2nd\3\2\2\2nh\3\2\2\2"+
		"o\17\3\2\2\2pq\5\22\n\2qr\b\t\1\2r\u0080\3\2\2\2st\5\26\f\2tu\b\t\1\2"+
		"u\u0080\3\2\2\2vw\5\32\16\2wx\b\t\1\2x\u0080\3\2\2\2yz\5\24\13\2z{\b\t"+
		...
		"\u0102\u0103\5\36\20\3\u0103\u0104\b\20\1\2\u0104\u0106\3\2\2\2\u0105"+
